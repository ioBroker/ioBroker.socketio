...
function checkPermissions(socket, command, callback, arg) {
    ...
    function socketEvents(socket, address) {
        ...
        let protectedCommands = ['cmdExec', 'getLocationOnDisk', 'getDiagData', 'getDevList', 'delLogs', 'writeDirAsZip', 'writeObjectsAsZip', 'readObjectsAsZip', 'checkLogging', 'updateMultihost'];
